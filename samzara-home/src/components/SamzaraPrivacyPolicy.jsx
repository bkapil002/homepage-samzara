    ...
    <div className="bg-white text-gray-800">
      ...
      <div className="relative">
        ...
        <div className="absolute bottom-0 left-0 w-full bg-gray-500/10 px-4 sm:px-8 md:px-19 lg:px-16 py-3 text-sm text-white">
          ...
          <span className="text-yellow-400 font-medium">Privacy Policy</span>
        </div>
      </div>
      ...
      <div className=" mx-auto px-4 sm:px-8 md:px-19 lg:px-16 py-8">
        ...
        <ul className="list-disc pl-6 space-y-2 text-[#5C5B5A]  text-[14px] mb-4">
          <li>
          ...
          <li>
            ...
            “Us” or “Our” in this Agreement) refers to Samzara India Pvt Ltd,
            Haryana, India.
          </li>
          <li>
          ...
          <li>
            <strong>Website</strong> refers to Samzara , accessible
            from{" "}
            <a
              href="https://community.samzara.in"
              className="text-blue-600 underline"
            >
              https://community.samzara.in
            </a>
          </li>
          <li>
        ...
        <h3 className="text-[21px] sm:text-[24px] font-bold text-gray-900 mb-2">
        ...
        <ul className="list-disc pl-6 space-y-2 text-[#5C5B5A]  text-[14px] mb-4">
          ...
          <li>
            <strong>Web Beacons.</strong> A cookie is a small file placed on
        ...
        <p className="text-[#5C5B5A]  text-[14px] mb-4">Administered by: Us</p>
        ...
        <ul className="list-disc pl-6 space-y-2 text-[#5C5B5A]  text-[14px] mb-3">
          <li>
        ...
        <ul className="list-disc pl-6 space-y-2 text-[#5C5B5A]  text-[14px] mb-4">
          <li>By email: info@findrehabcentres.com</li>
          <li>Protect and defend the rights or property of the Company</li>
          <li> By visiting this page on our website: <a href=" https://community.samzara.in" className=" cursor-pointer hover:underline"> https://community.samzara.in</a> </li>
          <li> By phone number: 9990025782</li>
        </ul>
      </div>
    </div>
  );
...
export default SamzaraPrivacyPolicy;
